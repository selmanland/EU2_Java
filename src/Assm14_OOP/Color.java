...
public class Color {
	...
	// rgb array with 3 ints is used to hold r,g,b values
		...
		public String toString() {
			...
			/*
			 * int[][] rgbS =
			 * {WHITE,BLACK,BLUE,CYAN,DARK_GRAY,GRAY,GREEN,LIGHT_GRAY,MAGENTA,ORANGE,PINK,
			 * RED,YELLOW};
			 * 
			 * for (int i =0; i< rgbS.length; i++) { if (rgbS [i]==rgb) {
			 * 
			 * } }
			 */
			...
			if (Arrays.equals(rgb, CYAN)) {
				return "CYAN";
			}
			if (Arrays.equals(rgb, DARK_GRAY)) {
				return "DARK_GRAY";
			}
			if (Arrays.equals(rgb, GRAY)) {
				return "GRAY";
			}
			if (Arrays.equals(rgb, GREEN)) {
				return "GREEN";
			}
			...
			if (Arrays.equals(rgb, ORANGE)) {
				return "ORANGE";
			}
			if (Arrays.equals(rgb, PINK)) {
				return "PINK";
			}
			if (Arrays.equals(rgb, RED)) {
				return "RED";
			}
