...
public class Pizza2DArray {
	...
	public static void main(String[] args) {
		...
		System.out.println("###FOR EACH LOOP###");	//System.out.println(Arrays.toString(pizzas[0]));
		...
		int[][] students = {
				{4,5,6}, 				// each row is a 1D array int [] inside 2d array int [][]
				{12,5,7},
				{23,56,12,55,3}
				};
		
		for(int[] group : students) {	// picking 1D array from 2D array
