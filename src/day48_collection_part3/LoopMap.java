...
public class LoopMap {
	...
	public static void main(String[] args) {
		...
		// ketSet -> returns set with all the keys in the map
		// values -> returns with all the values in the map

		for (String key : dataMap.keySet()) { // keys print out
			System.out.println(key);
		}

		for (String value : dataMap.values()) { // values print out
		...
		for (String each : dataMap.keySet()) {
			System.out.println(each + " | " + dataMap.get(each));
		}
